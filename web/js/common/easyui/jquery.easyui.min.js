...
if ($.permission) {//add by sdliang
$.permission.methods.check(_9b, "linkbuttonopts");
}
if(_9d){
...
if($.isArray(opts.toolbar)){
if ($.permission) {//add by sdliang
$.permission.methods.check(opts.toolbar, "toolbar");
}
...
if ($.permission) {//add by sdliang
$.permission.methods.check($(opts.toolbar).find("a"), "linkbutton");
}
...
//var _794=_791[_793];
    var _794;
    try{
        _794=eval("_791['"+_793.replace(/\./g,"']['")+"']"); //modify by xuwh
    }catch (e){
        _794 = "";
    };
